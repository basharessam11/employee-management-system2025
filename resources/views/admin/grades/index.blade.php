        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> {!! __('admin.Grades') !!}</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-datatable table-responsive">
                        ...
                        <div class="row mx-2">
                            {{ $grades->links('vendor.pagination.bootstrap-5') }}
                        </div>
                        <script>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('grades.destroy', 0) }}">
                                @method('delete')
                                @csrf
