        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> {!! __('admin.Departments') !!}</h5>
                            ...
                            @endif --}}
                                ...
                                @foreach ($departments as $key => $department)
                                    <tr class="odd">
                                        ...
                                        @if (App::isLocale('en'))
                                            <td> {{ $department->manager->name_en }}</td>
                                        @else
                                            <td> {{ $department->manager->name_ar }}</td>
                                        @endif
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                <a href="{{ route('department_user.show', $department->id) }}">
                                                    <button class="btn btn-sm btn-icon">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('departments.destroy', 0) }}">
                                @method('delete')
                                @csrf
