                                ...
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="location_id" class="form-select">
                                            @foreach ($locations as $loc)
                                                <option value="{{ $loc->id }}" @selected($user->location_id == $loc->id)>
                                                    {{ $loc->location }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="married" class="form-select">
                                            <option value="1" @selected($user->married == 1)>{!! __('admin.Married_yes') !!}
                                            </option>
                                            <option value="0" @selected($user->married == 0)>{!! __('admin.Married_no') !!}
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="date" class="form-control" name="ex_date_iqama"
                                            value="{{ old('ex_date_iqama', $user->ex_date_iqama) }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="paymant_method" class="form-select">
                                            <option value="0" @selected($user->paymant_method == 0)>{!! __('admin.Cash') !!}
                                            </option>
                                            <option value="1" @selected($user->paymant_method == 1)>{!! __('admin.Bank_Transfer') !!}
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="position_id" class="form-select">
                                            @foreach ($positions as $p)
                                                <option value="{{ $p->id }}" @selected($user->position_id == $p->id)>
                                                    {{ $p->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
