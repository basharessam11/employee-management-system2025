                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 1)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 1)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################1######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 2)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 2)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################2######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 3)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 3)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################3######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 4)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 4)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################4######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 5)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 5)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################5######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 6)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 6)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################6######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 7)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 7)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################7######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 8)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 8)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################8######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 9)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 9)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################9######################################### --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 10)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 10)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################10######################################## --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 11)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 11)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################11######################################## --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="comment[]" class="form-control" rows="3">{{ $result->answer()->where('num', 12)->first()->comment }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="score[]" class="form-control w-25"
                                                    min="0" max="10"
                                                    value="{{ $result->answer()->where('num', 12)->first()->score }}">
                                            </div>
                                        </div>
                                        <hr>
                                        {{-- #####################################12######################################## --}}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            @else
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="comment1" class="form-control" rows="3">{{ $result->comment }}</textarea>
                                                </div>
                                            @endif
                                        ...
                                        <div class="col-12 col-md-12">
                                            ...
                                            <table style="width: 100%" class="table table-bordered table-striped">
                                                <tbody>
                                                    <tr>
                                                        @if (App::isLocale('en'))
                                                            <th>Evaluator’s Recommendation</th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="comment2" class="form-control" rows="3">{{ $result->comment2 }}</textarea>
                                                            </div>
                                                        </td>
                                                        @if (App::isLocale('en'))
                                                            <td>Name :
